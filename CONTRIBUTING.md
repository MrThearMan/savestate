...
- All code should be typed when possible.
  ...
  - Create all custom types in `savestate/typing.py` and import them from there.
    This avoids circular imports.
  - Use of `TypedDict` is encouraged where dicts would be used.
  - Also import common types like `List` from `savestate/typing.py` instead of the built-in `typing` module.
...
[docs]: https://mrthearman.github.io/savestate/
[Issue]: https://github.com/MrThearMan/savestate/issues/new/choose
[bug report]: https://github.com/MrThearMan/savestate/issues/new?template=bug_report.yml
[feature request]: https://github.com/MrThearMan/savestate/issues/new?template=feature_request.yml
[discussions section]: https://github.com/MrThearMan/savestate/discussions
[pull request]: https://github.com/MrThearMan/savestate/compare
[fork]: https://github.com/MrThearMan/savestate/fork
[setup]: https://github.com/MrThearMan/savestate/blob/main/CONTRIBUTING.md#setting-up-the-environment
[tox]: https://tox.wiki/
[code-guidelines]: https://github.com/MrThearMan/savestate/blob/main/CONTRIBUTING.md#guidelines-for-writing-code
[docs-guidelines]: https://github.com/MrThearMan/savestate/blob/main/CONTRIBUTING.md#guidelines-for-writing-documentation
[reviewed]: https://github.com/MrThearMan/savestate/blob/main/CONTRIBUTING.md#code-review-process
[Github Actions]: https://github.com/features/actions
[pre-commit ci]: https://pre-commit.ci/
[new release]: https://github.com/MrThearMan/savestate/blob/main/CONTRIBUTING.md#creating-a-new-release
[semantic versioning]: https://semver.org/
[Draft a new release]: https://github.com/MrThearMan/savestate/releases/new
